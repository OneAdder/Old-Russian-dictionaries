...
4. `get_dict_links.py`: вставляет ссылки на PDF для словаря XI-XVII.
...
со словарём XI-XVII, а только несколько случайных в качестве примера (всех нет у нас самих). Данный словарь принадлежит его авторам.
